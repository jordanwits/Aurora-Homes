...
const INTRO_COPY =
  'We believe every piece of land carries its own character. Each home begins with listening—understanding the vision, the setting, and the life meant to unfold there. From that foundation, we craft spaces that feel rooted, intentional, and enduring.';
